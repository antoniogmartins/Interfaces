...
public class CT004_1_Finalizar_Compra {
	...
	@Test(priority=0)
	public void CT004_1_1_ValidarLogin_Usuario_Valido() throws InterruptedException{
	...
	@Test(priority=1)
	public void CT004_1_2_ColetarInformacao() throws InterruptedException{
	...
	@Test(priority=2)
	public void CT004_1_3_AdicionarProduto() throws InterruptedException{
	...
	@Test(priority=3)
	public void CT004_1_4_FazerChekout() throws InterruptedException{
	...
	@Test(priority=4)
	public void CT004_1_5_FinalizarCompra() throws InterruptedException{
     	//Criando uma Objeto da pagina de Finalizar Compra
		Thread.sleep(2000);
